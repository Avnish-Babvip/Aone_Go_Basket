      ...
      >
        ...
        <div className="w-full md:w-1/2 px-10 py-20 flex flex-col justify-center text-center">
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-4 py-2 mb-8 focus:ring-2 focus:ring-blue-500 outline-none"
          />

          <button className="w-full bg-gradient-to-r  from-blue-700 to-blue-950 text-white py-4 rounded-lg font-semibold shadow-md hover:shadow-lg transition">
