...
const CustomerKyc = () => {
  ...
  const { kycData, customerLoading } = useSelector(
    ...
    <>
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="font-semibold text-gray-800">All Customers Kyc Document</h2>
  ...
  <tr>
    ...
    <th className="text-left px-3 py-3 w-[180px]">Document Number</th>
    ...
    >
      ...
      <td className="px-3 py-5">
        <div className="flex gap-3 items-center">
          ...
          {item.document_type === "aadhaar" && item.document_back && (
            <a
