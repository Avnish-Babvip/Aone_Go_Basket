...
import { getAllCommissions } from "../../features/actions/commission";
import { EditCommissionModal } from "../../components/Modal/Commission/EditCommission";

const Commission = () => {
  const dispatch = useDispatch();
  const { commissionData, commissionLoading } = useSelector(
    ...
    <>
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="font-semibold text-gray-800">Commission List</h2>
        </div>
              ...
              {commissionLoading ? (
                ...
                data.map((item) => (
                  ...
                  >
                    ...
                    <td
                      className={`ps-5 px-3 py-5 font-medium ${
