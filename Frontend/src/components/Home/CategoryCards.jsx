...
const CategoryCard = ({ categoryData, loading, title, subtitle }) => {
  ...
  return (
    <section className="max-w-7xl mx-auto mt-16 px-4">
      <div className="mb-12 text-center">
        ...
        <p className="font-medium text-gray-500 mt-2">{subtitle}</p>
      </div>
  ...
  ${isEnd ? "opacity-0 pointer-events-none" : "opacity-100"}`}
        ...
        <p className="text-center text-gray-400 mb-16">No categories found.</p>
      )}
